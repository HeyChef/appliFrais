        ...
        <div class="container">
            <div class="row">
                ...
                <form action="fpdf/pdfphpvisite.php" name="valider" >
                        ...
                        ?>
                        <a class="icon2" target="blank" href="./fpdf/pdfphpvisite.php?mois=<?php echo $mois; ?>&id=<?php echo $_SESSION['Id'] ?>" title="Télécharger au format PDF"><i class="far fa-file-pdf"></i></a>
